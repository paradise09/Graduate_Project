...
class ResidualEncoder_5(nn.Module):
    def __init__(self, in_nc):
        ...
        self.block1 = ResidualBlock(in_channels=6, out_channels=16, kernel_size=3, stride=1) # 256
...
class ResidualEncoder_4(nn.Module):
    def __init__(self, in_nc):
        ...
        self.block1 = ResidualBlock(in_channels=6, out_channels=16, kernel_size=3, stride=1) # 128

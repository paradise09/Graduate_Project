...
class Refiner(torch.nn.Module):
    ...
    def forward(self, coarsemap, gray):
        ...
        gray_256 = gray_256.repeat(1, 3, 1, 1)
        coarsemap_256 = coarsemap_256.repeat(1, 3, 1, 1)        
        coarse_256_1, gray_256_1, sft_256_1 = self.block1(coarsemap_256, gray_256)
        ...
        gray_128 = gray_128.repeat(1, 3, 1, 1)
        coarsemap_128 = coarsemap_128.repeat(1, 3, 1, 1) 
        coarse_128_1, gray_128_1, sft_128_1 = self.block1(coarsemap_128, gray_128)
